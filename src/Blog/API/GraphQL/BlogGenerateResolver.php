...
readonly class BlogGenerateResolver extends AbstractGenerateResolver
{
    ...
    protected function getPrompt(array $args): string
    {
        ...
        return "Generate a general content for a new blog that will have posts later. Return result as JSON in the following form: {$this->getSchema()}.
        Name: {$name}. Description: {$description} (use html for better formatting, keep it short).
        Feel free to update both the name and the description. Be creative and give the blog a unique character.";
    }
